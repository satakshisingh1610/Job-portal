        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                </svg>
              </a>
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            <h3 className="text-white font-semibold mb-4 flex items-center">
              <AcademicCapIcon className="w-4 h-4 mr-2 text-blue-400" />
              For Students
            </h3>
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/student/saved-jobs" className="text-gray-400 hover:text-white transition-colors">
                  Saved Jobs
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/recruiter/create-job" className="text-gray-400 hover:text-white transition-colors">
                  Post a Job
                </Link>
              </li>
              <li>
                <Link to="/recruiter/applicants" className="text-gray-400 hover:text-white transition-colors">
                  View Applicants
                </Link>
              </li>
              <li>
                <Link to="/recruiter/company" className="text-gray-400 hover:text-white transition-colors">
                  Company Profile
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center text-gray-400">
                <EnvelopeIcon className="w-4 h-4 mr-3 text-blue-400" />
                support@jobportal.com
              </li>
              <li className="flex items-center text-gray-400">
                <PhoneIcon className="w-4 h-4 mr-3 text-green-400" />
                +1 (555) 123-4567
              </li>
              <li className="flex items-center text-gray-400">
                <MapPinIcon className="w-4 h-4 mr-3 text-purple-400" />
                San Francisco, CA
              </li>
            </ul>
          </div>
